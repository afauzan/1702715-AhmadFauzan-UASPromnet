			...
			<div class="table-title">
				<div class="row">
					...
					<div class="col-sm-6">
						...
						<a href="#" class="btn btn-success" data-toggle="modal"> <span>Cicil</span></a>
						<a href="#" class="btn btn-success" data-toggle="modal"> <span>Penjualan</span></a>
					</div>
				</div>
			</div>
				...
				<form action="<?php echo site_url('C_karyawan/add'); ?>" method="post">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							...
							<input type="email" name="harga_motor" class="form-control" required>
						</div>
